...
export default function ChatWidget({ 
  ...
  return (
    <div 
      className="cb:fixed cb:z-[999999] cb:font-sans"
    ...
    >
      {chat.isOpen ? (
        ...
        <div 
          ...
          className="cb:bg-[#0054a6] cb:rounded-full cb:flex cb:items-center cb:justify-center cb:cursor-pointer cb:shadow-lg cb:hover:scale-105 cb:hover:bg-[#004285] cb:transition-all"

            ...
            $posts = DB::connection('wordpress')->select("
                SELECT 
                    ...
                    (
                        ...
                        FROM vpnym_term_relationships r
                        INNER JOIN vpnym_term_taxonomy tt ON r.term_taxonomy_id = tt.term_taxonomy_id
                        INNER JOIN vpnym_terms t ON tt.term_id = t.term_id
